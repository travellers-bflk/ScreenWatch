...
<p align="center">
  <strong>隐私优先�?Windows 屏幕使用时间统计工具</strong><br/>
...
macOS 有原生的「屏幕使用时间」，�?Windows 用户一直没有一个好用的本地化替代方案。ScreenWatch 正是为此而生——它是一�?*完全离线、零数据上传**�?Windows 屏幕使用时间统计工具，参考了 macOS 的设计风格，同时注重保护用户隐私�?
...
- **数据库格�?*：SQLite 3
- **数据可控**：你可以随时通过应用内功能或手动删除文件来清除所有数�?
- **无备�?*：本软件不会将数据备份到任何云端或网络位�?
...
- **数据�?*：Microsoft.Data.Sqlite (SQLite)
...
ScreenWatch/
├── src/
�?  ├── ScreenWatch.Core/     # 核心库：数据层、服务、Win32 封装、模�?
�?  └── ScreenWatch.App/      # WPF 应用：UI、托盘、启动入�?
├── tests/
...
本项目基�?[MIT 许可证](LICENSE) 开源�?

## 致谢

- 灵感来源�?macOS 的「屏幕使用时间」功�?
- 感谢所有开源社区的贡献�?
